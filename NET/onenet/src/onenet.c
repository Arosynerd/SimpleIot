...
#define PROID			"f3q3NN3552"

#define ACCESS_KEY		"a1NJaUFtVEtyQ3p6cDU2bW01ME9PZHBwb0dsbkpYOTQ="

#define DEVICE_NAME		"App"
...
unsigned char OneNet_FillBuf(char *buf)
{
	...
	memset(text, 0, sizeof(text));
	sprintf(text, "\"humi1\":{\"value\":%d},", humi);
	strcat(buf, text);
